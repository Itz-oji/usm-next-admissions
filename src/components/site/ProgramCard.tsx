  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        <span className="text-[11px] font-medium uppercase tracking-wider text-primary">{p.level}</span>
      ...
      <div className="mt-6 pt-5 border-t border-border flex items-end justify-between">
        ...
        <div className="size-9 grid place-items-center rounded-full bg-foreground text-background group-hover:bg-secondary group-hover:text-secondary-foreground transition-colors">
